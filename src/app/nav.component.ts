...
@Component({
    ...
    template: `
        ...
        <mat-toolbar color="primary">
            <button mat-button (click)="display()">{{this.authentication.disAppName}}</button>
...
export class NavComponent {
    ...
    display(){
        ...
        if(this.authentication.isAuthenticated){
            console.log('AUTH');
            this.authentication.disAppName = 'Welcome ' + this.authentication.name;
            _router.navigateByUrl('/dashboard');
        }else{
            //console.log('NOT_AUTH');
            this.authentication.disAppName = 'RTDV';
